...
export const UI_STRINGS = {
  ...
  buildingModal: {
    ...
    get design() { return translateNow('buildingModal.design'); },
    get designBuilding() { return translateNow('buildingModal.designBuilding'); },
    get designRef() { return translateNow('buildingModal.designRef'); },
    get designYear() { return translateNow('buildingModal.designYear'); },
