...
export function createBuildingFilterRuleDraft(rule = {}) {
...
export function getNextBuildingFilterLayerColor(layers = []) {
...
export function createBuildingFilterLayerDraft(layer = {}, layers = []) {
  return {
