...
function createDataSettingsContext(options: LooseRecord = {}) {
  ...
  function normalizeFallbackData(raw: LooseRecord = {}) {
    return {
  ...
  function computeNextSyncAt(regionLike: LooseRecord = {}, referenceDate = now()) {
  ...
  function hasResolvedExtract(regionLike: LooseRecord = {}) {
