...
function withAdminError(handler, fallback: LooseRecord = {}) {
...
function registerAdminRoutes(deps: LooseRecord) {
  const { app, adminApiRateLimiter, requireAuth, requireAdmin, requireCsrfSession, getSessionEditActorKey } = deps;
  ...
  app.get(
    ...
    withAdminError(async (req, res) => {
      return sendPrivateJson(
        req,
        res,
        await adminSettingsService.buildEmailPreviewPayload({
  ...
  app.get(
    '/api/admin/app-settings/general',
    requireAuth,
    requireAdmin,
    requireMasterAdmin,
    withAdminError(
  ...
  app.post(
    ...
    withAdminError(
      async (req, res) => {
        return res.json({
          ok: true,
          item: await adminSettingsService.saveGeneralSettings(
            req.body?.general,
  ...
  app.post(
    '/api/admin/app-settings/smtp/test',
    requireCsrfSession,
    requireAuth,
    requireAdmin,
    requireMasterAdmin,
    withAdminError(
      async (req, res) => {
        return res.json(
          await adminSettingsService.sendSmtpTest({
            smtp: req.body?.smtp,
  ...
  app.post(
    '/api/admin/app-settings/data/filter-tag-allowlist',
    requireCsrfSession,
    requireAuth,
    requireAdmin,
    requireMasterAdmin,
    withAdminError(
      async (req, res) => {
        return res.json({
          ok: true,
          item: await adminSettingsService.saveFilterTagAllowlist(
            req.body?.allowlist,
            getSessionEditActorKey(req) || 'admin'
          )
        });
  ...
  app.get(
    '/api/admin/app-settings/data/filter-presets',
    requireAuth,
    requireAdmin,
    requireMasterAdmin,
    withAdminError(
  ...
  app.delete(
    '/api/admin/app-settings/data/filter-presets/:id',
    requireCsrfSession,
    requireAuth,
    requireAdmin,
    requireMasterAdmin,
  ...
  app.get(
    '/api/admin/app-settings/data/regions',
    requireAuth,
    requireAdmin,
    requireMasterAdmin,
    withAdminError(
  ...
  app.delete(
    '/api/admin/app-settings/data/regions/:regionId',
    requireCsrfSession,
    requireAuth,
    requireAdmin,
    requireMasterAdmin,
  ...
  app.post(
    '/api/admin/app-settings/data/regions/:regionId/sync-now',
    requireCsrfSession,
    requireAuth,
    requireAdmin,
    requireMasterAdmin,
    withAdminError(
      async (req, res) => {
        return res.json({
          ok: true,
          item: await adminSettingsService.requestRegionSync(
            req.params.regionId,
            getSessionEditActorKey(req) || 'admin'
          )
        });
  ...
  app.post(
    '/api/admin/app-settings/osm/oauth/start',
    requireCsrfSession,
    requireAuth,
    requireAdmin,
    requireMasterAdmin,
  ...
  app.get(
    '/api/admin/app-settings/osm/oauth/callback',
    requireAuth,
    requireAdmin,
    requireMasterAdmin,
    withAdminError(
  ...
  app.post(
    '/api/admin/osm-sync/candidates/sync',
    requireCsrfSession,
    requireAuth,
    requireAdmin,
    requireMasterAdmin,
    withAdminError(
      async (req, res) => {
        ...
        return res.json({
          ok: true,
          item: await osmSyncService.syncCandidatesToOsm(items, getSessionEditActorKey(req) || 'admin')
        });
      },
      {
        status: 500,
  ...
  app.get(
    '/api/admin/osm-sync/candidates/:osmType/:osmId',
    requireAuth,
    requireAdmin,
    withAdminError(
      async (req, res) => {
  ...
  app.post(
    '/api/admin/osm-sync/candidates/:osmType/:osmId/sync',
    requireCsrfSession,
    requireAuth,
    requireAdmin,
    requireMasterAdmin,
  ...
  app.get(
    '/api/admin/building-edits/:editId',
    requireAuth,
    requireAdmin,
    withAdminError(async (req, res) => {
  ...
  app.post(
    '/api/admin/building-edits/:editId/reject',
    requireCsrfSession,
    requireAuth,
    requireAdmin,
    withAdminError(async (req, res) => {
      return res.json(
        await adminEditsService.rejectBuildingEdit(req.params.editId, {
  ...
  app.post(
    '/api/admin/building-edits/:editId/reassign',
    requireCsrfSession,
    requireAuth,
    requireAdmin,
    withAdminError(async (req, res) => {
  ...
  app.post(
    '/api/admin/building-edits/bulk-merge',
    requireCsrfSession,
    requireAuth,
    requireAdmin,
    withAdminError(async (req, res) => {
      return res.json({
        ok: true,
        item: await adminEditsService.bulkMergeBuildingEdits(req.body?.editIds, {
          force: req.body?.force,
          comment: req.body?.comment,
          reviewer: getSessionEditActorKey(req) || 'admin'
        })
  ...
  app.post(
    '/api/admin/building-edits/:editId/merge',
    requireCsrfSession,
    requireAuth,
    requireAdmin,
    withAdminError(async (req, res) => {
      return res.json(
        await adminEditsService.mergeBuildingEdit(req.params.editId, {
          force: req.body?.force,
